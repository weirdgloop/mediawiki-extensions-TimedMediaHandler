...
class ID3Handler extends TimedMediaHandler {
	...
	/**
	 * Gets a codec string from metadata.
	 *
	 ...
	 * @return string|false The generated codec string.
	 */
	public function getCodecString( File $file ) {
		$metadata = $this->unpackMetadata( $file->getMetadata() );
		if ( !$metadata || isset( $metadata['error'] ) ) {
			return false;
		}

		return $metadata['video']['codec_string'] ?? false;
	}
}
